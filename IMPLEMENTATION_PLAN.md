...
- Create these screens:
  - Dashboard: level, animated XP bar, Gold, active path, current quest, optional backdrop artwork, editable timer presets, recent activity, and quick actions.
  - Quest Board: filters by path, stage, difficulty, and status; quest details; start, complete, reset/replay, and AI-assisted batch-import actions.
...
- Default to 20-, 25-, and 30-minute focus presets plus a 40-minute break preset, while allowing all four shortcuts to be edited beside the timer. Timers never grant rewards or gate quest completion. Closing the app saves the remaining time and restores it paused.
...
- Add restrained animations: card hover feedback, smooth XP/Gold counters, a circular timer, and short quest-completion/level-up particles. No audio will be included.
...
- Provide a copyable AI prompt and atomic quest-batch importer; the app never contacts an AI service itself.
